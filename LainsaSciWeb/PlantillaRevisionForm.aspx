...
<html xmlns="http://www.w3.org/1999/xhtml">
  ...
  <body>
    <form id="form1" runat="server">
      ...
      <div id="MainArea" class="normalText">
        <table style="width:100%;">
          ...
          <tr>
            ...
            <td>
              <div id="NoPeriodica" class="normalText" style="padding:5px;">
                <asp:CheckBox ID="chkNoPeriodica" runat="server" Text="No es periódica" />
              </div>
            </td>
            <td>
              <div id="Facturable" class="normalText" style="padding:5px;">
      ...
      <div id="FooterArea" class="normalText" align="right">
       <asp:Label ID="lblCarga" runat="server" Text="Guardando cambios..." Visible="false"></asp:Label>
      </div>
    </form>
  </body>
</html>

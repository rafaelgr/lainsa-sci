<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrupoUsuarioGrid.aspx.cs" Inherits="GrupoUsuarioGrid" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newGrupoUsuario()
          {
              //alert("newGrupoUsuario");
              var url = "GrupoUsuarioForm.aspx?Caller=GrupoUsuarioGrid";
              var name = "GrupoUsuarioForm";
              openOutSide(url, name);
          }
          function editGrupoUsuario(id)
          {
              var url = "GrupoUsuarioForm.aspx?Caller=GrupoUsuarioGrid" + "&GrupoUsuarioId=" + id;
              var name = "GrupoUsuarioForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="GrupoUsuarioId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" Visible="false"
                                         SortExpression="GrupoUsuarioId" UniqueName="GrupoUsuarioId">
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newGrupoUsuario();" 

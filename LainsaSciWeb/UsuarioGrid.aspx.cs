...
{
    public partial class UsuarioGrid : System.Web.UI.Page
    {
        ...
        protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
        {
            ...
            if (e.Item is GridDataItem)
            {
                ...
                string strKey = item.GetDataKeyValue("UsuarioId").ToString();
            ...
            if (typeOfControl.Equals("System.Web.UI.WebControls.ImageButton"))
            {
                ...
                switch (imgb.ID)
                {
                    ...
                    case "Delete":
                        try
                        {
                            Usuario u = CntLainsaSci.GetUsuario(id, ctx);
                            CntLainsaSci.CTXEliminar(u, ctx);
        ...
        {
            RadGrid1.DataSource = CntLainsaSci.GetUsuarios(ctx);
            if (rebind)
                RadGrid1.Rebind();
        }
        #endregion

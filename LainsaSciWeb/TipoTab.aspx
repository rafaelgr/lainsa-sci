<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoTab.aspx.cs" Inherits="TipoTab" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    <title>Tipo de dispositivo</title>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function loadValues(values) {
                var iframe = document.getElementById("ifTabTipo");
      ...
      <div id="MainArea" class="normalText" style="width:100%">
        <table width="100%">
              ...
              <telerik:RadTabStrip ID="RadTabStrip1" runat="server" 
                ...
                <Tabs>
                  <telerik:RadTab runat="server" Text="General" Value="general" Selected="True">
                    ...
                    <telerik:RadTab runat="server" Text="Modelos" Value="modelo">
                    </telerik:RadTab>
                  <telerik:RadTab runat="server" Owner="RadTabStrip1" Text="Plantillas" Value="plantilla">
                  </telerik:RadTab>
                </Tabs>
              </telerik:RadTabStrip>
            </td>
          ...
          <tr>
            <td>
              <iframe id="ifTabTipo" runat="server" frameborder="0" width="100%" height="500px"></iframe>
            </td>
          </tr>
          <tr>
            <td>

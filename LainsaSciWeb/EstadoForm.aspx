<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstadoForm.aspx.cs" Inherits="EstadoForm" %>
        ...
        <form id="form1" runat="server">
            ...
            <div id="MainArea" class="normalText">
                <table style="width:100%;">
                    <tr>
                        <td>
                            <div id="EstadoId" style="padding:5px;">
                                <asp:Label ID="lblEstadoId" runat="server" Text="ID"></asp:Label>
                                <br />
                                <telerik:RadTextBox ID="txtEstadoId" runat="server" Enabled="false">
                                </telerik:RadTextBox>
                            </div>
                        </td>
                        <td>
                            <div id="Empresa" class="normalText">
                                ...
                                <asp:ImageButton ID="imgEmpresa" runat="server" 
                                                 ...
                                                 OnClientClick="searchEmpresa('EstadoForm');" 
                    ...
                    <tr>
                        <td  colspan="2">
                            <div id="EstadoNombre" style="padding:5px;">
                    ...
                    <tr>
                        <td>
                            <div id="EnApertura" style="padding:5px;">
                                <asp:CheckBox ID="chkEnApertura" runat="server" Text="Estado para incidencia recién creada" TabIndex="2" />
                            </div>
                        </td>
                        <td>
                            <div id="EnCiere" style="padding:5px;">
                                <asp:CheckBox ID="chkEnCierre" runat="server" Text="Estado para incidencia cerrada" TabIndex="3" />
                            </div>
                        </td>
                    </tr>
                    <tr>

...
public partial class PlantillaGrid : System.Web.UI.Page
{
    ...
    protected void Page_Init(object sender, EventArgs e)
    {
        ...
        //
        permiso = CntLainsaSci.GetPermiso(usuario.GrupoUsuario, "plantillagrid", ctx);
        if (permiso == null)
        {
    ...
    protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            jCommand = String.Format("editPlantilla('{0}');", strKey);
            imgb.OnClientClick = jCommand;
        ...
        if (typeOfControl.Equals("System.Web.UI.WebControls.ImageButton"))
        {
            ...
            switch (imgb.ID)
            {
                ...
                case "Delete":
                    try
                    {
                        Plantilla p = CntLainsaSci.GetPlantilla(id, ctx);
    ...
    {
        RadGrid1.DataSource = CntLainsaSci.GetPlantillas(ctx);
        if (rebind)
            RadGrid1.Rebind();
    }
    #endregion

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlantillaRevisionTab.aspx.cs" Inherits="PlantillaRevisionTab" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script type="text/javascript" src="GridForm.js"></script>
          ...
          var iframe = document.getElementById("ifTabPlantillaRevision");
      ...
      <div id="MainArea" class="normalText" style="width:100%">
        <table width="100%">
            ...
            <td>
              <telerik:RadTabStrip ID="RadTabStrip1" runat="server" 
                ...
                <Tabs>
                  ...
                  <telerik:RadTab runat="server" Owner="RadTabStrip1" Text="Campo" Value="campo">
                  </telerik:RadTab>
                </Tabs>
              </telerik:RadTabStrip>
            </td>
          ...
          <tr>
            <td>
              <iframe id="ifTabPlantillaRevision" runat="server" frameborder="0" width="100%" height="500px"></iframe>
            </td>
          </tr>
          <tr>
            <td>

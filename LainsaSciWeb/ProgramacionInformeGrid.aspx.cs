...
public partial class ProgramacionInformeGrid : System.Web.UI.Page
{
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        if (ctx != null)
            ctx.Dispose();
        //
        //Session["ProgramacionInformeGrid"] = null;
    }
    #endregion
    ...
    protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            string strKey = item.GetDataKeyValue("ProgramacionInformeId").ToString();
            ...
            jCommand = String.Format("returnValues2('{0}','{1}');", strKey, item["Informe"].Text);
            ...
            jCommand = String.Format("editProgramacionInforme('{0}');", strKey);
            imgb.OnClientClick = jCommand;
            imgb.Visible = permiso.Ver;

            // assign to delete button (not needed by now)
            imgb = (ImageButton)item.FindControl("Delete");
            jCommand = String.Format("return radconfirm('{0}',event,300,100,'','{1}');", Resources.ResourceLainsaSci.DeleteRecordQuestion + " " + item["Informe"].Text, Resources.ResourceLainsaSci.DeleteRecord);
            imgb.OnClientClick = jCommand;
            imgb.Visible = permiso.Crear;
        }
    }

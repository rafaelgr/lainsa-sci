<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoGrid.aspx.cs" Inherits="TipoGrid" %>
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newTipo()
          {
              ...
              var url = "TipoTab.aspx?Caller=TipoGrid";
              var name = "TipoTab";
              openOutSide(url, name);
          }
          function editTipo(id)
          {
              var url = "TipoTab.aspx?Caller=TipoGrid" + "&TipoId=" + id;
              var name = "TipoTab";
              openOutSide(url, name);
          }
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newTipo();" 

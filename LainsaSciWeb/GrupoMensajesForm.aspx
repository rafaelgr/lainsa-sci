<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrupoMensajesForm.aspx.cs" Inherits="GrupoMensajesForm" %>
    ...
    <form id="form1" runat="server">
      ...
      <div id="MainArea" class="normalText">
        <table style="width:100%;">
          <tr>
            <td width="20%">
              <div id="GrupoMensajesId" style="padding:5px;">
                <asp:Label ID="lblGrupoMensajesId" runat="server" Text="ID:"></asp:Label>
                <br />
                <telerik:RadTextBox ID="txtGrupoMensajesId" runat="server" Width="100%" TabIndex="1">
                </telerik:RadTextBox>
              </div>
            </td>
            <td>
              <div id="Nombre" style="padding:5px;">
                <asp:Label ID="lblNombre" runat="server" Text="Nombre de grupo"></asp:Label>
                <br />

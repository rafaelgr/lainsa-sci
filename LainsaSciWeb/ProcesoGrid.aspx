<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProcesoGrid.aspx.cs" Inherits="ProcesoGrid" %>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          {
              //alert("newUsuario");
              var url = "ProcesoForm.aspx?Caller=ProcesoGrid";
              var name = "ProcesoForm";
              openOutSide(url, name);
          }
          function editProceso(id)
          {
              var url = "ProcesoForm.aspx?Caller=ProcesoGrid" + "&Nombre=" + id;
              var name = "ProcesoForm";
              openOutSide(url, name);
          }
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                ...
                <telerik:GridBoundColumn DataField="Descripcion" 
                                         FilterControlToolTip="Filtrar por descripcion" FilterImageToolTip="Filtro"
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newProceso();" 

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlantillaRevisionGrid.aspx.cs" Inherits="PlantillaRevisionGrid" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newPlantillaRevision()
          {
              //alert("newPlantillaRevision");
              var url = "PlantillaRevisionTab.aspx?Caller=PlantillaRevisionGrid";
              var name = "PlantillaRevisionTab";
              openOutSide(url, name);
          }
          function editPlantillaRevision(id)
          {
              var url = "PlantillaRevisionTab.aspx?Caller=PlantillaRevisionGrid" + "&PlantillaId=" + id;
              var name = "PlantillaRevisionTab";
              openOutSide(url, name);
          }
          ...
          function newPlantillaRevisionTipo(t) {
              //alert("newPlantillaRevision");
              var url = "PlantillaRevisionTab.aspx?Caller=PlantillaRevisionGrid" + "&TipoId=" + t;
              var name = "PlantillaRevisionTab";
              openOutSide(url, name);
          }
          function editPlantillaRevisionTipo(id,t) {
              var url = "PlantillaRevisionTab.aspx?Caller=PlantillaRevisionGrid" + "&PlantillaId=" + id + "&TipoId=" + t;
              var name = "PlantillaRevisionTab";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="PlantillaId" DataType="System.Int32" 
                ...
                <telerik:GridBoundColumn DataField="Descripcion" 
                                         FilterControlToolTip="Filtrar por la descripción" FilterImageToolTip="Filtro"
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newPlantillaRevision();" 

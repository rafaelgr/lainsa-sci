<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CategoriaForm.aspx.cs" Inherits="CategoriaForm" %>
    ...
    <form id="form1" runat="server">
      ...
      <div id="MainArea" class="normalText">
        <table style="width:100%;">
          <tr>
            <td width="20%">
              <div id="CategoriaId" style="padding:5px;">
                <asp:Label ID="lblCategoriaId" runat="server" Text="ID:"></asp:Label>
                <br />
                <telerik:RadTextBox ID="txtCategoriaId" runat="server" Width="100%" TabIndex="1">
                </telerik:RadTextBox>
              </div>
            </td>
            <td>

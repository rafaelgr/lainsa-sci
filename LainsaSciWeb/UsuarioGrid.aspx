<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsuarioGrid.aspx.cs" Inherits="LainsaSciWinWeb.UsuarioGrid" %>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          {
              //alert("newUsuario");
              var url = "UsuarioForm.aspx?Caller=UsuarioGrid";
              var name = "UsuarioForm";
              openOutSide(url, name);
          }
          function editUsuario(id)
          {
              var url = "UsuarioForm.aspx?Caller=UsuarioGrid" + "&UsuarioId=" + id;
              var name = "UsuarioForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="UsuarioId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" 
                                         SortExpression="UsuarioId" UniqueName="UsuarioId">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmpresaTab.aspx.cs" Inherits="EmpresaTab" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function refreshGrid2(arg, frame) {
                ...
                var iframe = document.getElementById("ifTabEmpresa");
      ...
      <div id="MainArea" class="normalText" style="width:100%">
        <table width="100%">
              ...
              <telerik:RadTabStrip ID="RadTabStrip1" runat="server" 
                ...
                <Tabs>
                  <telerik:RadTab runat="server" Text="General" Value="general" Selected="True">
                    ...
                    <telerik:RadTab runat="server" Text="Instalaciones" Value="instalaciones">
                    </telerik:RadTab>
                </Tabs>
          ...
          <tr>
            <td>
              <iframe id="ifTabEmpresa" runat="server" frameborder="0" width="100%" height="700px"></iframe>
            </td>
          </tr>
          <tr>
            <td>

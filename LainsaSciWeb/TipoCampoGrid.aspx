<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoCampoGrid.aspx.cs" Inherits="TipoCampoGrid" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newTipoCampo()
          {
              //alert("newInstalacion");
              var url = "TipoCampoForm.aspx?Caller=TipoCampoGrid";
              var name = "TipoCampoForm";
              openOutSide(url, name);
          }
          function editTipoCampo(id)
          {
              var url = "TipoCampoForm.aspx?Caller=TipoCampoGrid" + "&TipoCampoId=" + id;
              var name = "TipoCampoForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="TipoId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" Visible="false" 
                                         SortExpression="TipoId" UniqueName="TipoId">
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newTipoCampo();" 

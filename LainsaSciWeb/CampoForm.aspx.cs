...
public partial class CampoForm : System.Web.UI.Page
{
    ...
    {
        if (rdcTipoCampo.SelectedValue == "")
        {
            RadNotification1.Text = String.Format("<b>{0}</b><br/>{1}",
                                                  (string)GetGlobalResourceObject("ResourceLainsaSci", "Warning"),
                                                  (string)GetGlobalResourceObject("ResourceLainsaSci", "NecTipoCampo"));
            RadNotification1.Show();
            return false;
        }
        return true;
    ...
    protected void LoadData(Campo campo)
    {
        ...
        CargarInformeDe(campo.InformaDe);
    }
    protected void UnloadData(Campo campo)
    {
        ...
        campo.InformaDe = rdcInformaDe.SelectedValue;
    }
    ...
    protected void CargarInformeDe(string informeDe)
    {
        rdcInformaDe.Items.Clear();
        rdcInformaDe.Items.Add(new RadComboBoxItem("P.Timbre (Kg/cm2)", "PTimbre"));
        rdcInformaDe.Items.Add(new RadComboBoxItem("P.Prueba (Kg/cm2)", "PPrueba"));
        rdcInformaDe.Items.Add(new RadComboBoxItem(" ", ""));
        rdcInformaDe.SelectedValue = informeDe;
    }
}

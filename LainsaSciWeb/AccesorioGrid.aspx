<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccesorioGrid.aspx.cs" Inherits="AccesorioGrid" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newAccesorio()
          {
              //alert("newInstalacion");
              var url = "AccesorioForm.aspx?Caller=AccesorioGrid";
              var name = "AccesorioForm";
              openOutSide(url, name);
          }
          function editAccesorio(id)
          {
              var url = "AccesorioForm.aspx?Caller=AccesorioGrid" + "&AccesorioId=" + id;
              var name = "AccesorioForm";
              openOutSide(url, name);
          }
          function newAccesorioFromDispositivo(id) {
              //alert("newInstalacion");
              var url = "AccesorioAsignadoForm.aspx?Caller=DispositivoTab&DispositivoId=" + id;
              var name = "AccesorioAsignadoForm";
              openOutSide(url, name);
          }
//          function editAccesorioFromDispositivo(id) {
//              var url = "AccesorioForm.aspx?Caller=DispositivoTab" + "&AccesorioId=" + id;
//              var name = "AccesorioForm";
//              openOutSide(url, name);
//          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="AccesorioId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" 
                                         SortExpression="AccesorioId" UniqueName="AccesorioId">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Descripcion" 
                                         FilterControlToolTip="Filtrar por accesorio" FilterImageToolTip="Filtro"
              ...
              <EditFormSettings>
                <EditColumn FilterControlAltText="Filter EditCommandColumn column" FilterControlWidth="100%">
                </EditColumn>
              </EditFormSettings>
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newAccesorio();" 
            ...
            <FilterMenu EnableImageSprites="False" Width="100%">
            </FilterMenu>

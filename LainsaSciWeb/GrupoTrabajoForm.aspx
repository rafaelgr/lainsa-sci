<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrupoTrabajoForm.aspx.cs" Inherits="LainsaSciWinWeb.GrupoTrabajoForm" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
  <head id="Head1" runat="server">
    <title>Grupo trabajo</title>
    ...
    <form id="form1" runat="server">
      ...
      <div id="MainArea" class="normalText">
        <table style="width:100%;">
          <tr>
            <td>
              <div id="GrupoTrabajoId">
                <asp:Label ID="lblGrupoTrabajoId" runat="server" Text="ID"></asp:Label>
                <br />
                <telerik:RadTextBox ID="txtGrupoTrabajoId" runat="server" Enabled="false" Width="100px">
                </telerik:RadTextBox>
              </div>
            </td>
            <td>

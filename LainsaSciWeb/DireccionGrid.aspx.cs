...
public partial class DireccionGrid : System.Web.UI.Page
{
    ...
    {
        if (empresa != null)
            RadGrid1.DataSource = empresa.Direcciones;
        if (instalacion != null)
            RadGrid1.DataSource = instalacion.Direcciones;
        if (rebind)
            RadGrid1.Rebind();
    }
    #endregion

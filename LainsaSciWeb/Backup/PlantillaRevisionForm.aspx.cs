...
public partial class PlantillaRevisionForm : System.Web.UI.Page
{
    ...
    protected bool DataOk()
    {
        ...
        if (chkNoPeriodica.Checked == false)
        {
    ...
    protected void LoadData(PlantillaRevision plantillaRevision)
    {
        ...
        chkNoPeriodica.Checked = plantillaRevision.NoPeriodica;
        chkFacturable.Checked = plantillaRevision.Facturable;
    }
    ...
    protected void UnloadData(PlantillaRevision plantillaRevision)
    {
        ...
        if (chkNoPeriodica.Checked)
            plantillaRevision.NumeroPeriodos = 0;
        else
        ...
        plantillaRevision.NoPeriodica = chkNoPeriodica.Checked;
        plantillaRevision.Facturable = chkFacturable.Checked;
    }

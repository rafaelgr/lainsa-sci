<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoAnomaliaGrid.aspx.cs" Inherits="TipoAnomaliaGrid" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    <title>Tipos de anomalías</title>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newTipoAnomalia() 
          {
              //alert("newUsuario");
              var url = "TipoAnomaliaForm.aspx?Caller=TipoAnomaliaGrid";
              var name = "TipoAnomaliaForm";
              openOutSide(url, name);
          }
          function editTipoAnomalia(id)
          {
              var url = "TipoAnomaliaForm.aspx?Caller=TipoAnomaliaGrid" + "&TipoAnomaliaId=" + id;
              var name = "TipoAnomaliaForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="TipoAnomaliaId" 
                                         FilterControlToolTip="Filtrar por TipoAnomaliaId" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" 
                                         SortExpression="TipoAnomaliaId" UniqueName="TipoAnomaliaId">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Nombre" 
                                         FilterControlToolTip="Filtrar por Nombre" FilterImageToolTip="Filtro"
                                         HeaderText="TipoAnomalia" 
                                         ReadOnly="True" 
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newTipoAnomalia();" 

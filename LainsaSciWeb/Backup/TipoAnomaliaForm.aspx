<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TipoAnomaliaForm.aspx.cs" Inherits="TipoAnomaliaForm" %>
    ...
    <form id="form1" runat="server">
      ...
      <div id="MainArea" class="normalText">
        <table style="width:100%;">
          <tr>
            <td width="20%">
              <div id="TipoAnomaliaId" style="padding:5px;">
                <asp:Label ID="lblTipoAnomaliaId" runat="server" Text="ID:"></asp:Label>
                <br />
                <telerik:RadTextBox ID="txtTipoAnomaliaId" runat="server" Width="100%" TabIndex="1">
                </telerik:RadTextBox>
              </div>
            </td>
            <td>
              <div id="Nombre" style="padding:5px;">
                ...
                <asp:RequiredFieldValidator ID="valNombre" runat="server" Display="Dynamic" 
                                            ...
                                            ErrorMessage="Se necesita un nombre de TipoAnomalia">

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmpresaGrid.aspx.cs" Inherits="EmpresaGrid" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          {
              //alert("newEmpresa");
              var url = "EmpresaTab.aspx?Caller=EmpresaGrid";
              var name = "EmpresaTab";
              openOutSide(url, name);
          }
          function editEmpresa(id)
          {
              var url = "EmpresaTab.aspx?Caller=EmpresaGrid" + "&EmpresaId=" + id;
              var name = "EmpresaTab";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="EmpresaId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" Visible="false" 
                                         SortExpression="EmpresaId" UniqueName="EmpresaId">
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newEmpresa();" 

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstalacionGrid.aspx.cs" Inherits="InstalacionGrid" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newInstalacion()
          {
              //alert("newInstalacion");
              var url = "InstalacionTab.aspx?Caller=InstalacionGrid";
              var name = "InstalacionTab";
              openOutSide(url, name);
          }
          function newInstalacionFromEmpresa(empresaId) {
              //alert("newInstalacion");
              var url = "InstalacionTab.aspx?Caller=EmpresaTab&EmpresaId=" + empresaId;
              var name = "InstalacionTab";
              openOutSide(url, name);
          }
          function editInstalacion(id)
          {
              var url = "InstalacionTab.aspx?Caller=InstalacionGrid" + "&InstalacionId=" + id;
              var name = "InstalacionTab";
              openOutSide(url, name);
          }
          function editInstalacionFromEmpresa(id) {
              var url = "InstalacionTab.aspx?Caller=EmpresaTab" + "&InstalacionId=" + id;
              var name = "InstalacionTab";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="InstalacionId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" Visible="false" 
                                         SortExpression="InstalacionId" UniqueName="InstalacionId">
                ...
                <telerik:GridBoundColumn DataField="CodAx" 
                                         FilterControlToolTip="Filtrar por código AX" FilterImageToolTip="Filtro"
                                         HeaderText="Código AX" 
                                         ReadOnly="True" 
                                         SortExpression="CodAx" UniqueName="CodAx">
                </telerik:GridBoundColumn>
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newInstalacion();" 

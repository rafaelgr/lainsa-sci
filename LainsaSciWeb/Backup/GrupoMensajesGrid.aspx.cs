...
public partial class GrupoMensajesGrid : System.Web.UI.Page
{
    ...
    protected void Page_Unload(object sender, EventArgs e)
    {
        ...
        if (ctx != null)
            ctx.Dispose();
        //
        //Session["GrupoMensajesGrid"] = null;
    }
    #endregion
    ...
    protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            string strKey = item.GetDataKeyValue("GrupoMensajesId").ToString();
            ...
            jCommand = String.Format("editGrupoMensajes('{0}');", strKey);
            imgb.OnClientClick = jCommand;
    ...
    {
        RadGrid1.DataSource = CntLainsaSci.GetGruposMensajes(ctx);
        if (rebind)
            RadGrid1.Rebind();
    }
    #endregion

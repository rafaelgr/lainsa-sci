    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          {
              //alert("newUsuario");
              var url = "CategoriaForm.aspx?Caller=CategoriaGrid";
              var name = "CategoriaForm";
              openOutSide(url, name);
          }
          function editCategoria(id)
          {
              var url = "CategoriaForm.aspx?Caller=CategoriaGrid" + "&CategoriaId=" + id;
              var name = "CategoriaForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="CategoriaId" 
                                         FilterControlToolTip="Filtrar por CategoriaId" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" 
                                         SortExpression="CategoriaId" UniqueName="CategoriaId">
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newCategoria();" 

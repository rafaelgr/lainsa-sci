<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrupoMensajesGrid.aspx.cs" Inherits="GrupoMensajesGrid" %>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newGrupoMensajes() 
          {
              //alert("newUsuario");
              var url = "GrupoMensajesForm.aspx?Caller=GrupoMensajesGrid";
              var name = "GrupoMensajesForm";
              openOutSide(url, name);
          }
          function editGrupoMensajes(id)
          {
              var url = "GrupoMensajesForm.aspx?Caller=GrupoMensajesGrid" + "&GrupoMensajesId=" + id;
              var name = "GrupoMensajesForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="GrupoMensajesId" 
                                         FilterControlToolTip="Filtrar por GrupoMensajesId" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" 
                                         SortExpression="GrupoMensajesId" UniqueName="GrupoMensajesId">
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newGrupoMensajes();" 

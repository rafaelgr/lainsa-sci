...
//                }
      ...
      <div id ="Filtros">
        <table width="100%">
          ...
          <tr>  <td class="style1"> <div id="Botons">
        ...
        <td>
         <telerik:RadButton ID="RadButton2" runat="server" Text="Exportar" 
                ToolTip="Exportar a Excel" onclick="RadButton2_Click" Visible="False">
              </telerik:RadButton>
        </td>
        </tr>
        </table>

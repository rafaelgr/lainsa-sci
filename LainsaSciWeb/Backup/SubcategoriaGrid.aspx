<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SubcategoriaGrid.aspx.cs" Inherits="SubcategoriaGrid" %>
    ...
    <telerik:RadWindowManager ID="RadWindowManager1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          {
              var url = "SubcategoriaForm.aspx?Caller=SubcategoriaGrid";
              var name = "SubcategoriaForm";
              openOutSide(url, name);
          }
          function editSubcategoria(id)
          {
              var url = "SubcategoriaForm.aspx?Caller=SubcategoriaGrid" + "&SubcategoriaId=" + id;
              var name = "SubcategoriaForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="SubcategoriaId" 
                                         FilterControlToolTip="Filtrar por SubcategoriaId" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" 
                                         SortExpression="SubcategoriaId" UniqueName="SubcategoriaId">
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newSubcategoria();" 

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmailGrid.aspx.cs" Inherits="EmailGrid" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newEmail(owner, id, caller) 
          {
              //alert("newUsuario");
              var url = "EmailForm.aspx?Caller=" + caller;
              switch (owner)
              {
                  case "Empresa":
          ...
          function editEmail(id, caller)
          {
              var url = "EmailForm.aspx?Caller=" + caller + "&EmailId=" + id;
              var name = "EmailForm";
              openOutSide(url, name);
          }
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="EmailId" 
                                         ...
                                         HeaderText="ID" 
                                         ReadOnly="True" 
                                         SortExpression="EmailId" UniqueName="EmailId" Visible="false">
                ...
                <telerik:GridBoundColumn DataField="Envio" 
                                         FilterControlToolTip="Filtrar por dirección" FilterImageToolTip="Filtro"
                                         HeaderText="Envio" 
                                         ReadOnly="True" 
                                         SortExpression="Envio" UniqueName="Envio">
                </telerik:GridBoundColumn>
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newEmail();" 

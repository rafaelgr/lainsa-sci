<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TerminalTab.aspx.cs" Inherits="TerminalTab" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function loadValues(values) {
                var iframe = document.getElementById("ifTabTerminal");
      ...
      <div id="MainArea" class="normalText" style="width:100%">
        <table width="100%">
          <tr>
            <td>
                ...
                <Tabs>
                  ...
                  <telerik:RadTab runat="server" Text="Cargas" Value="cargas">
                  </telerik:RadTab>
                </Tabs>
              </telerik:RadTabStrip>
          </tr>
          <tr>
            <td>
              <iframe id="ifTabTerminal" runat="server" frameborder="0" width="100%" height="600px"></iframe>
            </td>
          </tr>
          <tr>
            <td>

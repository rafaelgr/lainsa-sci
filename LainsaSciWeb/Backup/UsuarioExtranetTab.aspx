<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UsuarioExtranetTab.aspx.cs" Inherits="UsuarioExtranetTab" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function loadValues(values) {
                var iframe = document.getElementById("ifTabUsuarioExtranet");
      ...
      <div id="MainArea" class="normalText" style="width:100%">
        <table width="100%">
              ...
              <telerik:RadTabStrip ID="RadTabStrip1" runat="server" 
                ...
                <Tabs>
                  <telerik:RadTab runat="server" Text="General" Value="general" Selected="True">
                    ...
                    <telerik:RadTab runat="server" Text="Categorias" Value="categorias">
                    </telerik:RadTab>
                </Tabs>
          ...
          <tr>
            <td>
              <iframe id="ifTabUsuarioExtranet" runat="server" frameborder="0" width="100%" height="700px"></iframe>
            </td>
          </tr>
          <tr>
            <td>

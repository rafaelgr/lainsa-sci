    ...
    <form id="form1" runat="server">
      ...
      <div id="AreaComun">
        <div id="Titulo" class="txtTitulo">
          <asp:Label ID="lblTitulo" runat="server" Text="Instalaciones"></asp:Label>
        </div>
        <div>
          &nbsp;
          &nbsp;
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False"  DataKeyNames="InstalacionId">
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="InstalacionId" DataType="System.Int32" 
                                         ...
                                         HeaderText="ID" 
                                         ReadOnly="True" 
                                         SortExpression="InstalacionId" UniqueName="InstalacionId" Visible="false">

...
<html xmlns="http://www.w3.org/1999/xhtml">
  <head runat="server">
    ...
    <link href="ExtranetEstilos.css" rel="stylesheet" type="text/css" />
  </head>
  <body>
    <form id="form1" runat="server">
      ...
      <div id="AreaComun">
        <div id="Titulo" class="txtTitulo">
            <asp:Label ID="lblTitulo" runat="server" Text="Empresas"></asp:Label>
        </div>
        <div>&nbsp;&nbsp;</div>
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False"  DataKeyNames="EmpresaId">
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="EmpresaId" DataType="System.Int32" 
                                         ...
                                         HeaderText="ID" 
                                         ReadOnly="True" 
                                         SortExpression="EmpresaId" UniqueName="EmpresaId" Visible="false">
                ...
                <telerik:GridTemplateColumn AllowFiltering="False" 
                  ...
                  <ItemTemplate>
                    <asp:ImageButton ID="Select" runat="server" 
                                     ...
                                     ToolTip="Ver instalaciones relacionadas" />
                  </ItemTemplate>

...
public partial class TipoGrid : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            jCommand = String.Format("returnValues3('{0}','{1}','{2}');", strKey, item["Nombre"].Text, "Tipo");
            ...
            jCommand = String.Format("editTipo({0});", strKey);
            imgb.OnClientClick = jCommand;
    ...
    {
        if (usuario == null)
            RadGrid1.DataSource = CntLainsaSci.GetTipoDispositivos(ctx);
        else
            RadGrid1.DataSource = CntLainsaSci.GetTipoDispositivos(usuario, ctx);
        if (rebind)
            RadGrid1.Rebind();
    }
    #endregion

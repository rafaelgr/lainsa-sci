...
public partial class TipoAnomaliaGrid : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            string strKey = item.GetDataKeyValue("TipoAnomaliaId").ToString();
            ...
            jCommand = String.Format("editTipoAnomalia('{0}');", strKey);
            imgb.OnClientClick = jCommand;
    ...
    {
        RadGrid1.DataSource = CntLainsaSci.GetTipoAnomalias(ctx);
        if (rebind)
            RadGrid1.Rebind();
    }
    #endregion

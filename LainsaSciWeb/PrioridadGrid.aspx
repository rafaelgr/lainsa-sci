<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrioridadGrid.aspx.cs" Inherits="PrioridadGrid" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newPrioridad()
          {
              //alert("newInstalacion");
              var url = "PrioridadForm.aspx?Caller=PrioridadGrid";
              var name = "PrioridadForm";
              openOutSide(url, name);
          }
          function editPrioridad(id)
          {
              var url = "PrioridadForm.aspx?Caller=PrioridadGrid" + "&PrioridadId=" + id;
              var name = "PrioridadForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="PrioridadId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" Visible="false" 
                                         SortExpression="PrioridadId" UniqueName="PrioridadId">
                ...
                <telerik:GridBoundColumn DataField="Nombre" 
                                         FilterControlToolTip="Filtrar por prioridad" FilterImageToolTip="Filtro"
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newPrioridad();" 

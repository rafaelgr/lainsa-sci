<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrupoUsuarioForm.aspx.cs" Inherits="GrupoUsuarioForm" %>
    ...
    <form id="form1" runat="server">
      ...
      <div id="MainArea" class="normalText">
        <table style="width:100%;">
          <tr>
            <td>
              <div id="GrupoUsuarioId">
                <asp:Label ID="lblGrupoUsuarioId" runat="server" Text="ID"></asp:Label>
                <br />
                <telerik:RadTextBox ID="txtGrupoUsuarioId" runat="server" Enabled="false" Width="100px">
                </telerik:RadTextBox>
              </div>
            </td>
            <td>

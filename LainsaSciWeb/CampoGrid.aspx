<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CampoGrid.aspx.cs" Inherits="CampoGrid" %>
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newCampo()
          {
              ...
              var url = "CampoForm.aspx?Caller=CampoGrid";
              var name = "CampoForm";
              openOutSide(url, name);
          }
          function editCampo(id)
          {
              var url = "CampoForm.aspx?Caller=CampoGrid" + "&CampoId=" + id;
              var name = "CampoForm";
              openOutSide(url, name);
          }
          function newCampoFromPlantilla(id) {
              //alert("newInstalacion");
              var url = "CampoForm.aspx?Caller=PlantillaRevisionTab&PlantillaId=" + id;
              var name = "CampoForm";
              openOutSide(url, name);
          }
          function editCampoFromPlantilla(id) {
              var url = "CampoForm.aspx?Caller=PlantillaRevisionTab&PlantillaId=" + gup("PlantillaId") + "&CampoId=" + id;
              var name = "CampoForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="CampoId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" Visible="false" 
                                         SortExpression="CampoId" UniqueName="CampoId">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="Nombre" 
                                         FilterControlToolTip="Filtrar por campo" FilterImageToolTip="Filtro"
                                         HeaderText="Nombre" 
                                         ReadOnly="True" 
                ...
                <telerik:GridBoundColumn DataField="TipoCampo.Descripcion" 
                                         FilterControlToolTip="Filtrar por campo" FilterImageToolTip="Filtro"
                                         HeaderText="Tipo de campo" 
                                         ReadOnly="True" 
                                         SortExpression="TipoCampo.Descripcion" UniqueName="TipoCampo.Descripcion">
                </telerik:GridBoundColumn>
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newCampo();" 

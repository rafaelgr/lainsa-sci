<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrioridadForm.aspx.cs" Inherits="PrioridadForm" %>
        ...
        <form id="form1" runat="server">
            ...
            <div id="MainArea" class="normalText">
                <table style="width:100%;">
                    <tr>
                        <td >
                            <div id="PrioridadId" style="padding:5px;">
                                <asp:Label ID="lblPrioridadId" runat="server" Text="ID"></asp:Label>
                                <br />
                                <telerik:RadTextBox ID="txtPrioridadId" runat="server" Enabled="false" TabIndex="1">
                                </telerik:RadTextBox>
                            </div>
                        </td>
                        <td>
                            <div id="Empresa" class="normalText">
                                ...
                                <asp:ImageButton ID="imgEmpresa" runat="server" 
                                                 ...
                                                 OnClientClick="searchEmpresa('PrioridadForm');" 
                                ...
                                <telerik:RadComboBox runat="server" ID="rdcEmpresa" Height="100px" 
                                                     ...
                                                     EmptyMessage="Escriba aquí ..." TabIndex="0" AutoPostBack="True" 
                    ...
                    <tr>
                        <td colspan="2">
                            <div id="PrioridadNombre" style="padding:5px;">

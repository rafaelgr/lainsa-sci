<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AccesorioForm.aspx.cs" Inherits="AccesorioForm" %>
      ...
      <div id="MainArea" class="normalText">
        <table style="width:100%;">
          <tr>
           ...
           <tr>
            <td>
              <div id="accesorioNombre" style="padding:5px;">
                <asp:Label ID="lblDesc" runat="server" Text="Descripcion:"></asp:Label>
                <br />
                <telerik:RadTextBox ID="txtDesc" runat="server" Width="100%" TabIndex="2" 
                      MaxLength="255" Rows="5" TextMode="MultiLine">
                </telerik:RadTextBox>
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" 
                                            ControlToValidate="txtDesc" CssClass="normalTextRed"

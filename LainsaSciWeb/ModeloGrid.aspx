<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ModeloGrid.aspx.cs" Inherits="ModeloGrid" %>
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newModelo()
          {
              ...
              var url = "";
              if (caller == "MainMenu")
                  url = "ModeloForm.aspx?Caller=ModeloGrid";
              else
                  url = "ModeloForm.aspx?Caller=" + caller;
              var name = "ModeloForm";
              openOutSide(url, name);
          }
          function newModeloTipo(id) {
              //alert("newInstalacion");
              var caller = gup("Caller");
              var url = "";
              if (caller == "MainMenu")
                  url = "ModeloForm.aspx?Caller=ModeloGrid&TipoId=" + id;
              else
                  url = "ModeloForm.aspx?Caller=" + caller + "&TipoId=" + id;
          ...
          function editModelo(id) {
              ...
              var url = "";
              if (caller == "MainMenu")
                  url = "ModeloForm.aspx?Caller=ModeloGrid" + "&ModeloId=" + id;
              else
                url = "ModeloForm.aspx?Caller=" + caller + "&ModeloId=" + id;
              var name = "ModeloForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="ModeloId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" Visible="false" 
                                         SortExpression="ModeloId" UniqueName="ModeloId">
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newModelo();" 

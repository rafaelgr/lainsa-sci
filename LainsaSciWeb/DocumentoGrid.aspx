    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          {
              //alert("newDocumento");
              var url = "DocumentoTab.aspx?Caller=DocumentoGrid";
              var name = "DocumentoTab";
              openOutSide(url, name);
          }
          function newDocumentoFromEmpresa(empresaId) {
              //alert("newDocumento");
              var url = "DocumentoTab.aspx?Caller=EmpresaTab&EmpresaId=" + empresaId;
              var name = "DocumentoTab";
              openOutSide(url, name);
          }
          function newDocumentoFromInstalacion(instalacionId)
          {
              //alert("newDocumento");
              var url = "DocumentoTab.aspx?Caller=InstalacionTab&InstalacionId=" + instalacionId;
              var name = "DocumentoTab";
              openOutSide(url, name);
          }
          function editDocumento(id)
          {
              var url = "DocumentoView.aspx?Caller=DocumentoGrid" + "&DocumentoId=" + id;
              var name = "DocumentoView";
              openOutSide(url, name);
          }
          function editDocumentoFromEmpresa(id) {
              var url = "DocumentoView.aspx?Caller=EmpresaTab" + "&DocumentoId=" + id;
              var name = "DocumentoView";
              openOutSide(url, name);
          }
          function editDocumentoFromInstalacion(id)
          {
              var url = "DocumentoView.aspx?Caller=InstalacionTab" + "&DocumentoId=" + id;
              var name = "DocumentoView";
              openOutSide(url, name);
          }
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="DocumentoId" DataType="System.Int32" 
                                         ...
                                         HeaderText="ID" 
                                         ReadOnly="True" 
                                         SortExpression="DocumentoId" UniqueName="DocumentoId">
                ...
                <telerik:GridBoundColumn DataField="Instalacion.Nombre" 
                                         FilterControlToolTip="Filtrar por Instalacion" FilterImageToolTip="Filtro"
                ...
                <telerik:GridBoundColumn DataField="Comentarios"  
                                         FilterControlToolTip="Filtrar por comentario" FilterImageToolTip="Filtro"
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newDocumento();" 

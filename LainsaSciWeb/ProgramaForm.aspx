        ...
        <form id="form1" runat="server">
            ...
            <telerik:RadTabStrip ID="RadTabStrip1" runat="server" SelectedIndex="0" 
                ...
                <Tabs>
                    <telerik:RadTab runat="server" PageViewID="RadPageView1" 
                        Text="Programa" Selected="True">
                    </telerik:RadTab>
                    <telerik:RadTab runat="server" PageViewID="RadPageView2" Text="Revisiones">
                    </telerik:RadTab>
                    <telerik:RadTab runat="server" PageViewID="RadPageView3" Text="Sustituciones">
                    </telerik:RadTab>
                </Tabs>
            </telerik:RadTabStrip>
           ...
           <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <div ID="Buttons" class="buttonsFormat">
                                        <asp:ImageButton ID="btnPrintInformePlanta" runat="server" 
                                                         ImageUrl="~/images/form_green_24.png"
                                                         ToolTip="Imprimir informe planta" TabIndex="1" onclick="btnPrintInformePlanta_Click" />
                                        &nbsp;
                                        <asp:ImageButton ID="btnPrintFormulario" runat="server" 
                                                         ImageUrl="~/images/form_red_24.png"
                                                         ToolTip="Imprimir formularios" TabIndex="1" onclick="btnPrintFormularios_Click" />
                                        &nbsp;
                ...
                <telerik:RadPageView ID="RadPageView2" runat="server">
                    <div id="Div2" class="normalText">
                        <div id="Revisiones" class="frameConMarco">
                            <asp:Label ID="lblRevisiones" runat="server" Text="Revisiones"></asp:Label>
                            <br />
                            <iframe id="ifRevisiones" runat="server" frameborder="0" width="100%" height="550px"></iframe>
                        </div>
                    </div>
                </telerik:RadPageView>
                <telerik:RadPageView ID="RadPageView3" runat="server">
                    <div id="MainArea" class="normalText">
                        <div id="Susutituciones" class="frameConMarco">
                            ...
                            <br />
                            <iframe id="ifSustituciones" runat="server" frameborder="0" width="100%" height="550px"></iframe>
                        </div>
                    </div>
                </telerik:RadPageView>

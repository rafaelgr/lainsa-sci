<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EstadoGrid.aspx.cs" Inherits="EstadoGrid" %>
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          function newEstado()
          {
              ...
              var url = "EstadoForm.aspx?Caller=EstadoGrid";
              var name = "EstadoForm";
              openOutSide(url, name);
          }
          function editEstado(id)
          {
              var url = "EstadoForm.aspx?Caller=EstadoGrid" + "&EstadoId=" + id;
              var name = "EstadoForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="EstadoId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" Visible="false" 
                                         SortExpression="EstadoId" UniqueName="EstadoId">
                ...
                <telerik:GridBoundColumn DataField="EnApertura" 
                                         FilterControlToolTip="Filtrar por modelo" FilterImageToolTip="Filtro"
                                         HeaderText="En apertura" 
                                         ReadOnly="True" 
                                         SortExpression="EnApertura" UniqueName="EnApertura">
                </telerik:GridBoundColumn>
                <telerik:GridBoundColumn DataField="EnCierre" 
                                         FilterControlToolTip="Filtrar por modelo" FilterImageToolTip="Filtro"
                                         HeaderText="En cierre" 
                                         ReadOnly="True" 
                                         SortExpression="EnCierre" UniqueName="EnCierre">
                </telerik:GridBoundColumn>
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newEstado();" 

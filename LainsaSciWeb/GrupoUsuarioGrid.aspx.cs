...
public partial class GrupoUsuarioGrid : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            string strKey = item.GetDataKeyValue("GrupoUsuarioId").ToString();
            ...
            jCommand = String.Format("returnValues3('{0}','{1}','{2}');", strKey, item["Nombre"].Text, "Grupo");
            ...
            jCommand = String.Format("editGrupoUsuario({0});", strKey);
            imgb.OnClientClick = jCommand;
    ...
    {
        RadGrid1.DataSource = CntLainsaSci.GetGruposUsuarios(ctx);
        if (rebind)
            RadGrid1.Rebind();
    }
    #endregion

<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProgramaGrid.aspx.cs" Inherits="ProgramaGrid" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          {
              //alert("newPrograma");
              var url = "ProgramaTab.aspx?Caller=ProgramaGrid";
              var name = "ProgramaTab";
              openOutSide(url, name);
          }
          function editPrograma(id)
          {
              var url = "ProgramaForm.aspx?Caller=ProgramaGrid" + "&ProgramaId=" + id;
              var name = "ProgramaForm";
              openOutSide(url, name);
          }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="ProgramaId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="Nro. Programa" 

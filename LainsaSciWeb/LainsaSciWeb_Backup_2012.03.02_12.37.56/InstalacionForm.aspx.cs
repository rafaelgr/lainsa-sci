...
public partial class InstalacionForm : System.Web.UI.Page
{
    ...
    protected void btnAccept_Click(object sender, ImageClickEventArgs e)
    {
        try
        {
            ...
            if (newRecord)
            {
                string url = String.Format("InstalacionTab.aspx?Caller=InstalacionGrid&InstalacionId={0}", instalacion.InstalacionId);
    ...
    protected void LoadData(Instalacion instalacion)
    {
        ...
        frm.Attributes["src"] = String.Format("DireccionGrid.aspx?InstalacionId={0}&Caller={1}&InFrame=S", instalacion.InstalacionId, caller2);
        frm2.Attributes["src"] = String.Format("EmailGrid.aspx?InstalacionId={0}&Caller={1}&InFrame=S", instalacion.InstalacionId, caller2);
        frm3.Attributes["src"] = String.Format("TelefonoGrid.aspx?InstalacionId={0}&Caller={1}&InFrame=S", instalacion.InstalacionId, caller2);

    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
          ...
          //              var url = "RevisionForm.aspx?Caller=DispositivoTab";
          //              var name = "RevisionForm";
          //              openOutSide(url, name);
          //          }
          //          function newRevisionFromDispositivo(dispositivoId) {
          //              //alert("newInstalacion");
          //              var url = "RevisionForm.aspx?Caller=DispositivoTab&DispositivoId=" + dispositivoId;
          //              var name = "RevisionForm";
          //              openOutSide(url, name);
          //          }
          ...
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top"
              ...
              <Columns>
                ...
                <telerik:GridBoundColumn DataField="GrupoProgramacion" Visible="false" 
                                         FilterControlToolTip="Filtrar por estado" FilterImageToolTip="Filtro"
                                         HeaderText="GP" ReadOnly="True" SortExpression="GrupoProgramacion" UniqueName="GrupoProgramacion">
                </telerik:GridBoundColumn>

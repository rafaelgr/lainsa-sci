<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InstalacionTab.aspx.cs" Inherits="InstalacionTab" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function loadValues(values) {
                var iframe = document.getElementById("ifTabInstalacion");
      ...
      <div id="MainArea" class="normalText" style="width:100%">
        <table width="100%">
            ...
            <td>
              <telerik:RadTabStrip ID="RadTabStrip1" runat="server" 
                ...
                <Tabs>
                  ...
                  <telerik:RadTab runat="server" Owner="RadTabStrip1" Text="Dispositivo" Value="dispositivo">
                  </telerik:RadTab>
                </Tabs>
              </telerik:RadTabStrip>
            </td>
          ...
          <tr>
            <td>
              <iframe id="ifTabInstalacion" runat="server" frameborder="0" width="100%" height="700px"></iframe>
            </td>
          </tr>
          <tr>
            <td>

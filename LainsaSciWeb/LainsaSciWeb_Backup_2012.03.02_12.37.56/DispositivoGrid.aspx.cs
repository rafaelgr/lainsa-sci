...
public partial class DispositivoGrid : System.Web.UI.Page
{
    ...
    protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
    {
        ...
        if (e.Item is GridDataItem)
        {
            ...
            string nomLargo = String.Format("({0}) {1} / {2}", item["Nombre"].Text, item["Instalacion.Empresa.Nombre"].Text, item["Instalacion.Nombre"].Text);
            if (LL == "")
    ...
    protected void RefreshGrid(bool rebind)
    {
        ...
        if (!chkCaducados.Checked) l = CntLainsaSci.NoCaducados(l);

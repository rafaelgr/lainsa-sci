<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SustitucionForm.aspx.cs" Inherits="SustitucionForm" %>
          ...
          <tr>
            <td width="20%" >
              <div id="SustitucionId" style="padding:5px;">
                ...
                <br />
                <telerik:RadTextBox ID="txtSustitucionId" runat="server" Enabled="false" Width="100%" TabIndex="1">
                </telerik:RadTextBox>
              </div>
            </td>
            <td >
              <div id="Fecha" class="normalText"  style="padding:5px;">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" 
                                            ControlToValidate="dtpFecha" CssClass="normalTextRed"
                                            ErrorMessage="Fecha necesaria">
            ...
            <td>
              <div id="Usuario" class="normalText"  style="padding:5px;">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="Dynamic" 
                                            ...
                                            ErrorMessage="Se necesita usuario">
                </asp:RequiredFieldValidator>
              </div>
            </td>
            <td>
              <div id="Estado" class="normalText"  style="padding:5px;">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" Display="Dynamic" 
                                            ControlToValidate="rdcEstado" CssClass="normalTextRed"
                                            ErrorMessage="Se necesita estado">
                </asp:RequiredFieldValidator>
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td colspan="3">
              <div ID="DispositivoOriginal" class="normalText" style="padding:5px;">
                ...
                &nbsp;
                <asp:ImageButton ID="imgDispositivoOriginal" runat="server"
                                 CausesValidation="false" ImageUrl="~/images/search_mini.png" 
                                 OnClientClick="searchDispositivo('SustitucionForm');" 
                ...
                <telerik:RadComboBox runat="server" ID="rdcDispositivoOriginal" Height="100px" CausesValidation="false" 
                                     ...
                                     onitemsrequested="rdcDispositivoOriginal_ItemsRequested" 
                                     onselectedindexchanged="rdcDispositivoOriginal_SelectedIndexChanged">
                </telerik:RadComboBox>
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Display="Dynamic" 
                                            ControlToValidate="rdcDispositivoOriginal" CssClass="normalTextRed"
                                            ErrorMessage="Se necesita un dispositivo">
                </asp:RequiredFieldValidator>
              </div>
            </td>
          </tr>
          <tr>
            ...
            <td colspan="3">
              <div ID="DispositivoSustituto" class="normalText" style="padding:5px;">
                ...
                &nbsp;
                <asp:ImageButton ID="imgDispositivoSustituto" runat="server"
                                 CausesValidation="false" ImageUrl="~/images/search_mini.png" 
                                 OnClientClick="searchDispositivo2('SustitucionForm');" 
                ...
                <telerik:RadComboBox runat="server" ID="rdcDispositivoSustituto" Height="100px" CausesValidation="false" 
                                     ...
                                     EnableLoadOnDemand="true" ShowMoreResultsBox="true" EnableVirtualScrolling="true"
                                     EmptyMessage="Escriba aquí ..." TabIndex="5" AutoPostBack="True" 
                                     onitemsrequested="rdcDispositivoSustituto_ItemsRequested" 
                                     onselectedindexchanged="rdcDispositivoSustituto_SelectedIndexChanged">
                </telerik:RadComboBox>
                <br />
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" Display="Dynamic" 
                                            ControlToValidate="rdcDispositivoSustituto" CssClass="normalTextRed"
                                            ErrorMessage="Se necesita un dispositivo">
                </asp:RequiredFieldValidator>
              </div>
            </td>

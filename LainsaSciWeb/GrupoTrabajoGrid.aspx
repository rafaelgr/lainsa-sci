<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GrupoTrabajoGrid.aspx.cs" Inherits="LainsaSciWinWeb.GrupoTrabajoGrid" %>
    ...
    <form id="form1" runat="server">
      ...
      <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            function newGrupoTrabajo() {
                //alert("newGrupoUsuario");
                var url = "GrupoTrabajoForm.aspx?Caller=GrupoTrabajoGrid";
                var name = "GrupoTrabajoForm";
                openOutSide(url, name);
            }
            function editGrupoTrabajo(id) {
                var url = "GrupoTrabajoForm.aspx?Caller=GrupoTrabajoGrid" + "&GrupoTrabajoId=" + id;
                var name = "GrupoTrabajoForm";
                openOutSide(url, name);
            }
        ...
        <div id="AreaGrid">
          <telerik:RadGrid ID="RadGrid1" runat="server"
            ...
            <MasterTableView AutoGenerateColumns="False" CommandItemDisplay="Top" 
              ...
              <Columns>
                <telerik:GridBoundColumn DataField="GrupoTrabajoId" DataType="System.Int32" 
                                         FilterControlToolTip="Filtrar por ID" FilterImageToolTip="Filtro"
                                         HeaderText="ID" 
                                         ReadOnly="True" Visible="false"
                                         SortExpression="GrupoTrabajoId" UniqueName="GrupoTrabajoId">
              ...
              <CommandItemTemplate>
                <div ID="ButtonAdd" style="padding:2px;">
                  <asp:ImageButton ID="New" runat="server" ImageUrl="~/images/document_add.png" 
                                   meta:resourceKey="NewResource1" OnClientClick="newGrupoTrabajo();" 

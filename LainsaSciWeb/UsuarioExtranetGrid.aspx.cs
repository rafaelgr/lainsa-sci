...
{
    public partial class UsuarioExtranetGrid : System.Web.UI.Page
    {
        ...
        protected void RadGrid1_ItemDataBound(object sender, GridItemEventArgs e)
        {
            if (e.Item is GridCommandItem)
            {
                ...
                if (empresa != null)
                {
                    jCommand = String.Format("newUsuarioEmpresa({0});", empresa.EmpresaId);
                    imgb.OnClientClick = jCommand;
                }
                if (instalacion != null)
                {
                    jCommand = String.Format("newUsuarioInstalacion({0});", instalacion.InstalacionId);
                    imgb.OnClientClick = jCommand;
                }
            }
            if (e.Item is GridDataItem)
            {
                ...
                string strKey = item.GetDataKeyValue("UsuarioExtranetId").ToString();
                ...
                jCommand = String.Format("editUsuario({0});", strKey);
                imgb.OnClientClick = jCommand;

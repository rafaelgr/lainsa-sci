...
namespace LainsaSciExtranet
{
    public static class CntWinWeb
    {
        ...
        {
            if (fecha.ToString() == "01/01/0001 0:00:00" || fecha == null) return true;
            else return false;
        }
        public static void PrepareUserFolder(string userDir)
        {
            // Borra todo el contenido del directorio de usuario recreándolo
